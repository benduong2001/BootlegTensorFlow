...
class CROSSENTROPY(COST_FUNCTION_HOLDER):
    ...
    def apply(self, predicted_vector, target_vector):
        ...
        for i in range(vector_dimen):
            p = softmax_vector[i]
            t = target_vector[i]
            temp_log_loss_drv = t * mt.log(p + 1e-20)
...
class Categ_NN:
    ...
    def _rand_parameters(self, parameter_list):
        ...
        for parameter in parameter_list:
            ...
            np_parameter = np.random.rand(height, width).astype(float)
...
"""
[[[ 1.54410607  0.01528031]
 [-1.58630574  0.77471751]], [[0.50181515]
 [0.47914893]], [[-1.54713436  2.42971725]
 [ 1.31548196  1.11282427]
 [ 1.4136153  -1.77714866]], [[ 0.20290929]
 [-0.09471133]
 [ 1.39585314]]]

[[[ 1.23957898 -0.6340519 ]
 [ 1.3679855  -0.03362716]], [[0.89189664]
 [0.13906823]], [[-1.11850499 -0.74962563]
 [ 0.40907609  1.39789047]
 [ 2.66102578  1.3570791 ]], [[ 1.39379703]
 [ 0.26458577]
 [-0.34552235]]]
...
def categ_test():
    ...
    Softboighost.set_test_verifier_holder(DISTRIBUTION_VERIFIER())
...
def linreg_test():
    ...
    Onionghost.set_test_verifier_holder(LINREG_VERIFIER())
